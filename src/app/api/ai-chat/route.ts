...
- 사용자가 "자세하게", "자세히", "상세하게", "상세히", "표로 보여줘" 같은 요청을 할 때만 표 형식 사용
- 기본적으로는 콤마로 구분된 간단한 나열 방식 사용

## 데이터 표시 형식 (표 형식은 사용자가 명시적으로 요청할 때만 사용)
사용자가 "자세하게", "자세히", "상세하게", "상세히", "표로 보여줘" 같은 명시적 요청을 할 때만 다음과 같은 마크다운 테이블 형식으로 보여주세요:
...
사용자가 "자세하게", "자세히", "상세하게", "상세히", "표로 보여줘" 같은 명시적 요청을 할 때만 표 형식 사용:
...
**표 형식 (사용자가 "자세하게", "자세히", "상세하게", "상세히", "표로 보여줘" 같은 명시적 요청을 할 때만):**
