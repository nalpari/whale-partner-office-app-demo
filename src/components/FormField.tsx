interface FormFieldProps {
  label: string;
  value: string;
  type: "input" | "select" | "date" | "disabled";
  required?: boolean;
  ...
  return (
    <div className="form-field-row">
      ...
      <div className="form-field-input-wrapper">
        <div className={type === "disabled" ? "form-field-input-disabled" : "form-field-input"}>
          <div className={type === "disabled" ? "form-field-input-text-disabled" : "form-field-input-text"}>
            {value}
          </div>
